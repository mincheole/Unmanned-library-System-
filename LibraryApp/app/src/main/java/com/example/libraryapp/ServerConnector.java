...
public class ServerConnector {
    public static class ConnectionParams{   // 각 멤버변수(파라미터)를 가진 클래스 생성
        ...
        public ConnectionParams setId(int jspOption, String id){    // 파라미터 객체 + 빌더 패턴
            this.jspOption = jspOption;
            this.id = id;
            return this;
        }
        ...
        public ConnectionParams setRfid(int jspOption, String rfid){
            this.jspOption = jspOption;
            this.rfid = rfid;
            return this;
        }

        public ConnectionParams setTitle(int jspOption, String title, String mode){
            this.jspOption = jspOption;
            this.title = title;
            this.mode = mode;
            return this;
    ...
    public static String connect(ConnectionParams params) {     // JSP와 통신 메소드, 파라미터를 담은 클래스 타입의 객체를 매개변수로 넘겨받음.
        ...
        switch (params.jspOption) {     // 로그인 화면이랑 대여정보 화면에서 connect() 메소드를 사용하기 위함(1일때 로그인, 2일때 대여정보)
            ...
            case 2:     // 대여정보
                ...
                break;
            case 3:     // 대출반납RFID 전송
                urlPath = "http://whereisthebook.kro.kr:8080/DbConn1/f_rfidkey.jsp?rfid="+params.rfid;
                break;
            case 4:     // 책검색
